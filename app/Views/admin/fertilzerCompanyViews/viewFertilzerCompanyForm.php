        ...
        <div class="col-12">
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">Fertilzer Company Details</h3>
                </div><!--//.card-header -->
                <?= csrf_field() ?>
                <div class="card-body">
...
<!-- Company -->
                    ...
                    <div class="row" id="fertilzercompanies">
                        <div class="col-md-12 col-lg-6 px-4">
                            <div class="mb-3 icon-input-container">
                                ...
                                <div class="input-group">
									...
									value="<?= isset($oldInput) && $oldInput['company'] ? $oldInput['company'] : old('company', $fertilzerCompany->company) ?>">
                                </div>
                                <?php if ($ferr) { ?>
                                    <?= $ferr ?>
                            </div>
...
<!-- State -->
                        ...
                        <div class="mb-3" id="fertilzercompanies">
                            ...
                            <select id="state" name="state" class="form-control select2bs2" style="width: 100%;">
                                ...
                                <?php if (isset($stateList) && is_array($stateList) && !empty($stateList)) :
                                    foreach ($stateList as $k => $v) : ?>
                                        <option value="<?= $k ?>" <?= isset($oldInput) && $oldInput['state'] == $k ? ' selected' : ''; ?> <?= ($k == $fertilzerCompany->state) ? ' selected' : '' ?>>
                                            <?= $v ?>
                                        </option>
                                <?php endforeach;
                                endif; ?>
...
<!-- Postcode -->
                        ...
                        <div class="mb-3" id="fertilzercompanies">
							...
							value="<?= isset($oldInput) && $oldInput['postcode'] ? $oldInput['postcode'] : old('postcode', $fertilzerCompany->postcode) ?>" readonly style="background-color: #e9ecef;"> <!-- Gray background for readonly input -->
                            <?php if ($ferr) : ?>
 ...
 <!-- Phone Number -->
                   ...
                   <div class="mb-3 icon-input-container" id="fertilzercompanies">
                        <label for="phoneNo" class="form-label">
							<?=lang('FertilzerCompanies.phoneNo') ?>
                        </label>
                        <div class="input-group">
                            <span class="input-group-text">
							...
							?>" value="<?= isset($oldInput) && $oldInput['phone_no'] ? $oldInput['phone_no'] : old('phone_no', $fertilzerCompany->phone_no) ?>">
                        </div>
                        <?php if ($ferr) { ?>
                            <div class="invalid-feedback">
                                <?= $ferr ?>
...
<!-- Street -->
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="street" name="street" maxLength="200" class="form-control<?= ($ferr = session('formErrors.street')) ? ' is-invalid' : '' ?>" value="<?= isset($oldInput) && $oldInput['street'] ? $oldInput['street'] : old('street', $fertilzerCompany->street) ?>">
                                <?php if ($ferr) { ?>
                                    <div class="invalid-feedback">
                                        <?= $ferr ?>
                                    </div>
                                ...
                                <select id="suburb" name="suburb" class="form-control select2bs2" style="width: 100%;">
                                    ...
                                    <?php if (isset($postcodeAustraliaListList) && is_array($postcodeAustraliaListList) && !empty($postcodeAustraliaListList)) :
                                        foreach ($postcodeAustraliaListList as $k => $v) : ?>
                                            <option value="<?= $k ?>" <?= isset($oldInput) && $oldInput['suburb'] == $k ? ' selected' : ''; ?> <?= $k ==$fertilzerCompany->suburb ? ' selected' : '' ?>>
                                                <?= $v ?>
                                            </option>
                                    <?php endforeach;
                                    endif; ?>
...
<!-- Country -->
                            ...
                            <div class="mb-3" id="fertilzercompanies">
								...
								value="<?= isset($oldInput) && $oldInput['postcode'] ? $oldInput['postcode'] : old('postcode', $fertilzerCompany->country) ?>" readonly style="background-color: #e9ecef;"> <!-- Gray background for readonly input -->
                                <?php if ($ferr) { ?>
                                    <div class="invalid-feedback">
                                        <?= $ferr ?>
                                    </div>
...
<!-- ABN -->
                        ...
                        <div class="mb-3" id="fertilzercompanies">
                            ...
                            <input type="text" id="abn" name="abn" maxLength="100" class="form-control<?= ($ferr = session('formErrors.abn')) ? ' is-invalid' : '' ?>" value="<?= isset($oldInput) && $oldInput['abn'] ? $oldInput['abn'] : old('abn', $fertilzerCompany->abn) ?>">
                            <?php if ($ferr) { ?>
                                <div class="invalid-feedback">
                                    <?= $ferr ?>
                                </div>
    ...
    <div class="card card-info mt-3">
        ...
        <div class="card-body">
            ...
            <!-- First Name -->
                    ...
                    <div class="row" id="fertilzercompanies">
                        ...
                        <div class="input-group">
							...
							?>" value="<?= isset($oldInput) && $oldInput['first_name'] ? $oldInput['first_name'] : old('first_name', $fertilzerCompany->first_name) ?>">
                        </div>
                        <?php if ($ferr) { ?>
                            <div class="invalid-feedback">
                                <?= $ferr ?>
            ...
            <!-- Email Address -->
                    ...
                    <div class="mb-3 icon-input-container">
                        ...
                        <div class="input-group">
							...
							?>" value="<?= isset($oldInput) && $oldInput['email_address'] ? $oldInput['email_address'] : old('email_address', $fertilzerCompany->email_address) ?>">
                        </div>
                        <?php if ($ferr) { ?>
                            <div class="invalid-feedback">
                                <?= $ferr ?>
            ...
            <!-- Title -->
                    ...
                    <div class="mb-3 icon-input-container" id="fertilzercompanies">
                        ...
                        <div class="input-group">
							...
							?>" value="<?= isset($oldInput) && $oldInput['title'] ? $oldInput['title'] : old('title', $fertilzerCompany->title) ?>">
                        </div>
                        <?php if ($ferr) { ?>
                            <div class="invalid-feedback">
                                <?= $ferr ?>
            ...
            <!-- Last Name -->
                        ...
                        <div class="col-md-12 col-lg-6 px-4" id="fertilzercompanies">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
							...
							?>" value="<?= isset($oldInput) && $oldInput['last_name'] ? $oldInput['last_name'] : old('last_name', $fertilzerCompany->last_name) ?>">
                            <?php if ($ferr) { ?>
                                <div class="invalid-feedback">
                                    <?= $ferr ?>
                                </div>
                    ...
                    <div class="mb-3 icon-input-container" id="fertilzercompanies">
                        <label for="mobileNumber" class="form-label">
                            ...
                            <div class="input-group">
								...
								?>" value="<?= isset($oldInput) && $oldInput['mobile_number'] ? $oldInput['mobile_number'] : old('mobile_number', $fertilzerCompany->mobile_number) ?>">
                            </div>
                            <?php if ($ferr) { ?>
                                <div class="invalid-feedback">
                                    <?= $ferr ?>
        ...
        <div class="card-body">
            ...
            <!-- Sales Tax Default-->
                    ...
                    <div class="row" id="fertilzercompanies">
                        ...
                        if ($isAddPage && isset($formatted_created_at)) {
                            $fertilzerCompany->created_at = $formatted_created_at;
                        }
                        ?>
						...
						?>" value="<?= old('created_at', $fertilzerCompany->created_at) ?>" readonly style="background-color: #e9ecef;"> <!-- Gray background for readonly input -->
                        <?php if ($ferr) { ?>
                            <div class="invalid-feedback">
                                <?= $ferr ?>
                            </div>
            ...
            <!-- Updated At -->        
				    ...
				    <input type="datetime-local" id="updatedAt" name="updated_at" maxLength="20"
					    ...
					    value="<?= old('updated_at', $fertilzerCompany->formatted_updated_at ?? $fertilzerCompany->updated_at) ?>" readonly>
				            <?php if ($ferr): ?>
					    <div class="invalid-feedback">
							<?= $ferr ?>
						        </div>
            ...
            <!-- Created By -->
                    ...
                    <div class="mb-3">
						...
						?>" value="<?= $isAddPage ? $loggedInUsername : old('created_by', $fertilzerCompany->created_by) ?>" readonly style="background-color: #e9ecef;"> <!-- Gray background for readonly input -->
                        <?php if ($ferr) { ?>
                            <div class="invalid-feedback">
                                <?= $ferr ?>
                            </div>
            ...
            <!-- Updated By -->
                    ...
                    <div class="mb-3" id="fertilzercompanies">
                        ...
                        <?=lang('FertilzerCompanies.updatedBy') ?>
                        </label>
						...
						?>" value="<?= $isEditPage ? $loggedInUsername : old('updated_by', $fertilzerCompany->updated_by) ?>" readonly style="background-color: #e9ecef;"> <!-- Gray background for readonly input -->
                        <?php if ($ferr) { ?>
                            <div class="invalid-feedback">
                                <?= $ferr ?>
                            </div>
            ...
            <!-- Save -->
                    ...
                    <div class="">
                    <?= anchor(route_to("fertilzerCompanyList"), lang("Basic.global.Cancel"), ["class" => "btn btn-secondary float-start"]) ?>
