                        ...
                        <div class="col-md-12 col-lg-6 px-4">
                            <div class="mb-3 icon-input-container">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="companyName" name="company_name" maxLength="250" class="form-control<?= ($ferr = session('formErrors.company_name')) ? ' is-invalid' : '' 
                                    ?>" value="<?= isset($oldInput) && $oldInput['company_name'] ? $oldInput['company_name'] : old('company_name', $company->company_name) ?>">
                                </div>
                                <?php if ($ferr) { ?>
                                    <?= $ferr ?>
                            </div>
...
<!-- Postcode -->
                        ...
                        <div class="mb-3" id="companies">
                            ...
                            <input type="text" id="postcode" name="postcode" maxLength="20" class="form-control-disabled<?= ($ferr = session('formErrors.postcode')) ? ' is-invalid' : '' 
                            ?>" value="<?= isset($oldInput) && $oldInput['postcode'] ? $oldInput['postcode'] : old('postcode', $company->postcode) ?>" readonly>
                            <?php if ($ferr) : ?>
...
<!-- Longitude -->
                        ...
                        <div class="mb-3" id="companies">
                            ...
                            <input type="text" id="lon" name="lon" maxLength="20" class="form-control-disabled<?= ($ferr = session('formErrors.lon')) ? ' is-invalid' : '' 
                            ?>" value="<?= isset($oldInput) && $oldInput['lon'] ? $oldInput['lon'] : old('lon', $company->lon) ?>" readonly>
                            <?php if ($ferr) { ?>
                                <div class="invalid-feedback">
                                    <?= $ferr ?>
                                </div>
...
<!-- ABN -->
                        ...
                        <div class="mb-3" id="companies">
                            ...
                            <input type="text" id="abn" name="abn" maxLength="100" class="form-control<?= ($ferr = session('formErrors.abn')) ? ' is-invalid' : '' 
                            ?>" value="<?= isset($oldInput) && $oldInput['abn'] ? $oldInput['abn'] : old('abn', $company->abn) ?>">
                            <?php if ($ferr) { ?>
                                <div class="invalid-feedback">
                                    <?= $ferr ?>
                                </div>
...
<!-- Street -->
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="street" name="street" maxLength="200" class="form-control<?= ($ferr = session('formErrors.street')) ? ' is-invalid' : '' 
                                ?>" value="<?= isset($oldInput) && $oldInput['street'] ? $oldInput['street'] : old('street', $company->street) ?>">
                                <?php if ($ferr) { ?>
                                    <div class="invalid-feedback">
                                        <?= $ferr ?>
                                    </div>
...
<!-- Country -->
                            ...
                            <div class="mb-3" id="companies">
                                ...
                                <input type="text" id="country" name="country" maxLength="20" class="form-control-disabled<?= ($ferr = session('formErrors.country')) ? ' is-invalid' : '' 
                                ?>" value="<?= isset($oldInput) && $oldInput['postcode'] ? $oldInput['postcode'] : old('postcode', $company->country) ?>" readonly>
                                <?php if ($ferr) { ?>
                                    <div class="invalid-feedback">
                                        <?= $ferr ?>
                                    </div>
...
<!-- Latitude -->
                            ...
                            <div class="mb-3" id="companies">
                                ...
                                <input type="text" id="lat" name="lat" maxLength="20" class="form-control-disabled<?= ($ferr = session('formErrors.lat')) ? ' is-invalid' : '' 
                                ?>" value="<?= isset($oldInput) && $oldInput['lat'] ? $oldInput['lat'] : old('lat', $company->lat) ?>" readonly>
                                <?php if ($ferr) { ?>
                                    <div class="invalid-feedback">
                                        <?= $ferr ?>
                                    </div>
...
<!-- First Name -->
                    ...
                    <div class="row" id="companies">
                        ...
                        <div class="input-group">
                            ...
                            ?>" value="<?= isset($oldInput) && $oldInput['first_name'] ? $oldInput['first_name'] : old('first_name', $company->first_name) ?>">
                        </div>
                        <?php if ($ferr) { ?>
                            <div class="invalid-feedback">
                                <?= $ferr ?>
...
<!-- Email Address -->
                    ...
                    <div class="mb-3 icon-input-container">
                        ...
                        <div class="input-group">
                            ...
                            ?>" value="<?= isset($oldInput) && $oldInput['email_address'] ? $oldInput['email_address'] : old('email_address', $company->email_address) ?>">
                        </div>
                        <?php if ($ferr) { ?>
                            <div class="invalid-feedback">
                                <?= $ferr ?>
            ...
            <!-- Phone Number -->
                    ...
                    <div class="mb-3 icon-input-container" id="companies">
                        ...
                        <div class="input-group">
                            ...
                            ?>" value="<?= isset($oldInput) && $oldInput['phone_no'] ? $oldInput['phone_no'] : old('phone_no', $company->phone_no) ?>">
                        </div>
                        <?php if ($ferr) { ?>
                            <div class="invalid-feedback">
                                <?= $ferr ?>
            ...
            <!-- Last Name -->
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            ?>" value="<?= isset($oldInput) && $oldInput['last_name'] ? $oldInput['last_name'] : old('last_name', $company->last_name) ?>">
                            <?php if ($ferr) { ?>
                                <div class="invalid-feedback">
                                    <?= $ferr ?>
                                </div>
            ...
            <!-- Mobile Number -->
                        ...
                        <div class="mb-3 icon-input-container" id="companies">
                            ...
                            <div class="input-group">
                                ...
                                ?>" value="<?= isset($oldInput) && $oldInput['mobile_number'] ? $oldInput['mobile_number'] : old('mobile_number', $company->mobile_number) ?>">
                            </div>
                            <?php if ($ferr) { ?>
                                <div class="invalid-feedback">
                                    <?= $ferr ?>
            ...
            <!-- Title -->
                    ...
                    <div class="mb-3 icon-input-container" id="companies">
                        ...
                        <div class="input-group">
                            ...
                            ?>" value="<?= isset($oldInput) && $oldInput['title'] ? $oldInput['title'] : old('title', $company->title) ?>">
                        </div>
                        <?php if ($ferr) { ?>
                            <div class="invalid-feedback">
                                <?= $ferr ?>
        ...
        <div class="card-body">
            ...
            <!-- Sales Tax Default-->
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="salesTaxDefault" name="sales_tax_default" maxLength="50" class="form-control-disabled<?= ($ferr = session('formErrors.sales_tax_default')) ? ' is-invalid' : '' 
                        ?>" value="<?= isset($oldInput) && $oldInput['sales_tax_default'] ? $oldInput['sales_tax_default'] : old('sales_tax_default', $company->sales_tax_default) ?>" readonly>
                        <?php if ($ferr) { ?>
                            <div class="invalid-feedback">
                                <?= $ferr ?>
                            </div>
            ...
            <!-- Created At -->
                    ...
                    <div class="mb-3" id="companies">
                        ...
                        ?>
                        <input type="datetime-local" id="createdAt" name="created_at" maxLength="20" class="form-control-disabled<?= ($ferr = session('formErrors.created_at')) ? ' is-invalid' : ''
                        ?>" value="<?= old('created_at', $company->created_at) ?>" readonly>
                        <?php if ($ferr) { ?>
                            <div class="invalid-feedback">
                                <?= $ferr ?>
                            </div>
            ...
            <!-- Created By -->
                    ...
                    <div class="mb-3">
                        ...
                        ?>" value="<?= $isAddPage ? $loggedInUsername : old('created_by', $company->created_by) ?>" readonly style="background-color: #e9ecef;"> <!-- Gray background for readonly input -->
                        <?php if ($ferr) { ?>
                            <div class="invalid-feedback">
                                <?= $ferr ?>
                            </div>
            ...
            <!-- Updated By -->
                    ...
                    <div class="mb-3" id="companies">
                        ...
                        <input type="text" id="updatedBy" name="updated_by" maxLength="120" class="form-control-disabled<?= ($ferr = session('formErrors.updated_by')) ? ' is-invalid' : '' 
                        ?>" value="<?= $isEditPage ? $loggedInUsername : old('updated_by', $company->updated_by) ?>" readonly>
                        <?php if ($ferr) { ?>
                            <div class="invalid-feedback">
                                <?= $ferr ?>
                            </div>
